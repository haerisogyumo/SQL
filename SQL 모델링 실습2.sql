...
insert into `Doctors` values ('D102101','김춘추','1989-05-30','M','102','과장','010-2101-1979','kimcc@bw.com');
insert into `Doctors` values ('D102104','이사부','1979-04-13','M','102','전문의','010-2104-1966','leesabu@bw.com');
insert into `Doctors` values ('D103101','장보고','1966-09-12','M','103','과장','010-3101-1979','jangbg@bw.com');
insert into `Doctors` values ('D104101','선덕여왕','1979-07-28','F','104','과장','010-4101-1984','gueen@bw.com');
...
insert into `Patients` values ('P105101', 'D105101', 'N104101', '원빈', '660912-1234567', 'M', '대전', '010-2104-6609', 'one@daum.net', '배우');
...
insert into `Nurses` values ('N104101', '김태리', '1979-08-28', 'F', '104', '주임', '010-3101-7908', 'taeh@bw.com');
...
#Charts
insert into `Charts` values ('C1021001', '1021001', 'D102101', 'P102101', 'N102101', '감기 주사 및 약 처방');
