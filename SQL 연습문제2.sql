...
#실습2-2
	create table `bank_customer` (
		`c_no`		char(14) not null primary key,
...
#실습2-3
    ...
    insert into `bank_customer` values ('870830-1000004', '강감찬', '1', '010-1234-1004', '서울시 영둥포구');
    ...
    insert into `bank_account` values ('101-11-1003', 'S1', '자유저축예금', '870830-1000004', '53000', '2007-02-27');
